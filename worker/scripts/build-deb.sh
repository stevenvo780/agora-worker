...
echo ""
echo "  # List workspace IDs:"
echo "  sudo edu-worker-manager ids"
echo ""
echo "  # Remove a workspace worker:"
echo "  sudo edu-worker-manager remove <workspaceId>"
echo ""
echo "  # Force resync:"
echo "  sudo edu-worker-manager resync <workspaceId|all>"
echo ""
echo "  # Tip: 'status' now shows the Workspace ID needed for remove/logs."
echo ""
EOF
